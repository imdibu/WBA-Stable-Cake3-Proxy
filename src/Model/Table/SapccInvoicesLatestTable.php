...
use App\Model\Entity\SapccInvoicesLatest;
use Cake\ORM\Query;
...
class SapccInvoicesLatestTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('ship_to_party_code', 'create')
            ->notEmpty('ship_to_party_code');
