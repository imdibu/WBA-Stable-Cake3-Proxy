...
use App\Model\Entity\EsquelCustomerMaterial;
use Cake\ORM\Query;
 ...
 */
class EsquelCustomerMaterialsTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_esquel_customer_materials');
