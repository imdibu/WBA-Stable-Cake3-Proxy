 ...
 */
class CabinetsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('cabinet_code', 'create')
            ->notEmpty('cabinet_code')
            ->add('cabinet_code', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['cabinet_code']));
