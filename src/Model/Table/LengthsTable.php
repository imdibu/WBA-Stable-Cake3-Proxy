 ...
 */
class LengthsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('length_name', 'create')
            ->notEmpty('length_name')
            ->add('length_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['length_name']));
