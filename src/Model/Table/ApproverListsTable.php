...
use App\Model\Entity\ApproverList;
use Cake\ORM\Query;
 ...
 */
class ApproverListsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('value_start')
            ->requirePresence('value_start', 'create')
            ->notEmpty('value_start');

        $validator
            ->decimal('value_until')
            ->requirePresence('value_until', 'create')
            ->notEmpty('value_until');

        $validator
            ->integer('enable_email_notify')
            ->requirePresence('enable_email_notify', 'create')
            ->notEmpty('enable_email_notify');
