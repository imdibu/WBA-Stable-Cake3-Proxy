...
use App\Model\Entity\CustomerShipToParty;
use Cake\ORM\Query;
 ...
 */
class CustomerShipToPartiesTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_customer_ship_to_parties');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_ship_to_party_name', 'create')
            ->notEmpty('customer_ship_to_party_name');
