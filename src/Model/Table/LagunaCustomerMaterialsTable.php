...
use App\Model\Entity\LagunaCustomerMaterial;
use Cake\ORM\Query;
 ...
 */
class LagunaCustomerMaterialsTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_laguna_customer_materials');
