...
use App\Model\Entity\QuantityFactor;
use Cake\ORM\Query;
 ...
 */
class QuantityFactorsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('qty_for_bulk_order', 'create')
            ->notEmpty('qty_for_bulk_order');

        $validator
            ->requirePresence('qty_for_sap_order', 'create')
            ->notEmpty('qty_for_sap_order');
