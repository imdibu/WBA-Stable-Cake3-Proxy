...
use App\Model\Entity\MaterialGroup;
use Cake\ORM\Query;
 ...
 */
class MaterialGroupsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('material_group', 'create')
            ->notEmpty('material_group')
            ->add('material_group', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['material_group']));
