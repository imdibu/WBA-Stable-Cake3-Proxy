...
use App\Model\Entity\WarehouseInstruction;
use Cake\ORM\Query;
 ...
 */
class WarehouseInstructionsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('warehouse_instructions', 'create')
            ->notEmpty('warehouse_instructions');
