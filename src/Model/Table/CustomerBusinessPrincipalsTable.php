...
use App\Model\Entity\CustomerBusinessPrincipal;
use Cake\ORM\Query;
...
/**
 * CustomerBusinessPrincipals Model
 *
 ...
 */
class CustomerBusinessPrincipalsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_business_principal_name', 'create')
            ->notEmpty('customer_business_principal_name');
