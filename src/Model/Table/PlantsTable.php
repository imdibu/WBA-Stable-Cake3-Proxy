 ...
 */
class PlantsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('plant_name')
            ->add('plant_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
        ...
        $validator
            ->allowEmpty('lab_email');

        $validator
            ->integer('lead_time')
            ->allowEmpty('lead_time');

        $validator
            ->integer('cust_platinum')
            ->allowEmpty('cust_platinum');

        $validator
            ->integer('cust_gold')
            ->allowEmpty('cust_gold');

        $validator
            ->integer('cust_silver')
            ->allowEmpty('cust_silver');

        $validator
            ->integer('cust_bronze')
            ->allowEmpty('cust_bronze');
    ...
    {
        $rules->add($rules->isUnique(['plant_name']));
