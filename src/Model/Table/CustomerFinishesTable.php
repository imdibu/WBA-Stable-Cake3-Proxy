...
use App\Model\Entity\CustomerFinish;
use Cake\ORM\Query;
 ...
 */
class CustomerFinishesTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_finish_name', 'create')
            ->notEmpty('customer_finish_name');
