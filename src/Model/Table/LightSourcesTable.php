...
use App\Model\Entity\LightSource;
use Cake\ORM\Query;
 ...
 */
class LightSourcesTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_light_sources');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('light_source', 'create')
            ->notEmpty('light_source')
            ->add('light_source', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['light_source']));
