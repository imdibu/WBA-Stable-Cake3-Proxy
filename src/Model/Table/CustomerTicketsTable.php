...
use App\Model\Entity\CustomerTicket;
use Cake\ORM\Query;
 ...
 */
class CustomerTicketsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_ticket', 'create')
            ->notEmpty('customer_ticket');
