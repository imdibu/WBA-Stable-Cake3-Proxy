...
use App\Model\Entity\CustomerBrand;
use Cake\ORM\Query;
 ...
 */
class CustomerBrandsTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_brand_name', 'create')
            ->notEmpty('customer_brand_name');
