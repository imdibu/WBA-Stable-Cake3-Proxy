...
use App\Model\Entity\SampleUpload;
use Cake\ORM\Query;
 ...
 */
class SampleUploadsTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_sample_uploads');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('upload_file_name', 'create')
            ->notEmpty('upload_file_name');
