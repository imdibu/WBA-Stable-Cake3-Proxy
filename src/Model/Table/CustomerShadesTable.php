...
use App\Model\Entity\CustomerShade;
use Cake\ORM\Query;
 ...
 */
class CustomerShadesTable extends CoatsTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('coats_customer_shades');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('customer_shade_name', 'create')
            ->notEmpty('customer_shade_name');
