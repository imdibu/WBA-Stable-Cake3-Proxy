...
use App\Model\Entity\TypeOrder;
use Cake\ORM\Query;
 ...
 */
class TypeOrdersTable extends CoatsTable
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->add('order_type_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['order_type_name']));
