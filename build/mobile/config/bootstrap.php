...
switch (Configure::read('env')) {
	...
	case 'AX':
		...
		define('SAP_URL','http://172.18.1.139:56500/WebServicePortal/execute?service=InboundSalesOrderIdoc&template=CCEversion03');
	    //define('SAP_URL','http://172.18.1.139:56500/WebServicePortal/execute?service=InboundSalesOrderIdoc&template=CCEversion02');
        //define('SAP_URL','http://172.18.2.149:57500/WebServicePortal/execute?service=InboundSalesOrderIdoc&template=CCEversion02');			
        ...
        define('SAP_ORDER_SCOPE_URL', 'http://172.18.2.149:57500/wba/api/OrderUpdateScope');
		...
		define('SHARED_BACKEND_FAILED_FOLDER',TMP . 'backend_uploads/failed_files/');
			...
			//define('SHARED_BACKEND_FAILED_FOLDER','//coawcswebp01.systems02.services/failed_files/');
	...
	case 'HK':
        ...
        define('CC_REPORT_OUTSTANDING_PAYMENT_URL', 'http://172.18.2.149:57500/wba/api/OutstandingPaymentsReport');
        define('DOMAIN_URL','hkwcs.coatscolorexpress.com');
        Configure::write('GisIps', array(
            '192.168.0.79',
            '192.168.0.93',
            '192.168.0.111',
        ...
        define('SAP_ORDER_SCOPE_URL', 'http://172.18.2.149:57500/WebServicePortal/execute?service=OrderUpdateScopeHK');
...
define('SAP_URL','http://172.18.1.139:56500/WebServicePortal/execute?service=InboundSalesOrderIdoc&template=CCEversion03');
        define('SAP_ATP_URL', 'http://172.18.2.149:57500/wba/api/Atpcheck');
        define('SAP_PRICE_CHECK_URL', 'http://172.18.1.129:55500/wba/api/Netprice');
        ...
        define('DOMAIN_URL','qa.wcs.coatscolorexpress.com');
        Configure::write('GisIps', array(
            '192.168.0.79',
            '192.168.0.93',
            '192.168.0.111',
        ...
        define('SAP_ORDER_DATA_URL', 'http://172.18.1.129:55500/wba/api/OrderUpdateInfo');
        Configure::write('SapClientGMT', array(
            // date('H') => SAP Instance
            '2'=>array('SAP700'),
            '7'=>array('SAP701'),
